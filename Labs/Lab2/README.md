...
2) Почему протокол STP выбрал эти порты в качестве портов корневого моста на этих коммутаторах? **Из-за наименьшего идентификатора порта отправителя: порт e0/0 и e0/2 коммутатора S1 соответственно**
