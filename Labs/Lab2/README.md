...
В качестве результатов шагов 1-3 ниже приведена часть вывода команды show running-config коммутаторов, соответствующая настройкам указанным в пунке 3
...
### Результаты шага 4
 В качестве результатов шага 4 приведена проверка способности коммутаторов обмениваться эхо-запросами:
 1) S1 - S2
 2) S1 - S3
 3) S2 - S3
...
### Результаты шагов 1-3
В качестве результатов шагов 1-3 ниже приведена часть вывода команды show running-config коммутаторов, соответствующая настройкам интерфейсов
...
### Результаты шага 4
В качестве результатов шага 4 приведен вывод команды show spanning-tree коммутаторов
...
3) Просмотреть изменения протокола spanning-tree
