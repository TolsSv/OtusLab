...
## Часть 2. Настройка и проверка 2 пулов DHCPv4 сервера на маршрутизаторе R1

### Настройка DHCPv4 сервера на маршрутизаторе R1
...
## Часть 3. Настройка и проверка ретрансляции DHCPv4 на маршрутизаторе R2
