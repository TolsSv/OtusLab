...
После базовой настройки маршрутизатора в конфигурации маршрутизатора появятся настройки:
```
...
## Результаты шага 5
 В качестве результатов шага 5 приведены выводы команды ping для:
