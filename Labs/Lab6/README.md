...
Для фильтрации зоны 101 переведем ее в totally-stub area на маршрутизаторах R19 и R14.
...
Настроим на маршрутизаторе R15 фильтрацию на отправку обновлений в зону 102, запретив отправку в нее маршрута в зону 101.
