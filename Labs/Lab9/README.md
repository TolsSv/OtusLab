...
Необходимо настроить на маршрутизаторах R22 и R21 соседство для ipv4 и ipv6.
...
Необходимо включить на маршрутизаторах R23 и R24 eBGP, назначить им router-id и настроить соседство между R22 и R23, R21 и R24 для ipv4 и ipv6.
...
Необходимо включить на маршрутизаторах R18 и R26 eBGP, назначить им router-id и настроить соседство между R24 и R18, R26 и R18 для ipv4 и ipv6.
